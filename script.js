...
/********************************************************************
// Demo 3: Classify uploaded image
********************************************************************/

const imageUpload = document.getElementById('image-upload');
const classifyUploadButton = document.getElementById('classify-upload');
const uploadPreview = document.getElementById('upload-preview');
const uploadResults = document.getElementById('upload-results');

classifyUploadButton.addEventListener('click', classifyUploadedImage);

function classifyUploadedImage() {
  if (!model) {
    console.log('Wait for model to load before classifying!');
    return;
  }
  ...
  uploadPreview.innerHTML = '<p>Loading image...</p>';
